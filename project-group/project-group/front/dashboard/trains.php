  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <table id="exampless" class="table text-nowrap table-striped md:table-fixed " style="width:100%">
                <thead>
        ...
        if(obj.data_type == 'read'){
          ...
          if(typeof obj.data == 'object'){
            for (var i = 0; i < obj.data.length; i++) {
              ...
              <button style="margin-right:5px" onclick="get_edit_row(${row.id});" 
              type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModaledit" data-bs-whatever="@fat"
               >
                Edit
              </button>
