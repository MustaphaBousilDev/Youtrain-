            ...
            if(typeof obj == 'object'){
                if(obj.data_type == 'read'){
                    ...
                    if(typeof obj.data == 'object'){
                        ...
                        <button style="margin-left:5px" onclick="get_edit_row(${row.id});"  class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-2 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="authentication-modal">
                            Edit
                        </button>
