...
<html lang="en">
  ...
  <body class="">
    ...
    <section class="flex justify-center items-center flex-w">
      <div class="h-full gradient-form  md:h-screen">
          ...
          <div class="xl:w-10/12">
            <div  class="block shadow-lg rounded-lg">
              <div class="lg:flex lg:flex-wrap g-0">
                <div class="lg:w-7/12 px-4 md:px-0" style="padding:20px">
                ...
                <div
                  class="lg:w-5/12 sm:hidden lg:flex items-center lg:rounded-r-lg rounded-b-lg lg:rounded-bl-none"
                  style="
